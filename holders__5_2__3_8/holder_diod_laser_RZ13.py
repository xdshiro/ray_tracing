...
if __name__ == '__main__':
	...
	for focus in focuses:
		...
		print(
			f'RZ13_2_dist_{round(dist, 2)}_foc_{round(focus, 2)}_rfoc_{round(r_foc, 2)}_{x_res}_{number_rays}_r{r}_15n14even')
		...
		print(
			f' RZ13_2_dist_{round(dist, 2)}_foc_{round(focus, 2)}_rfoc_{round(r_foc, 2)}_{x_res}_{number_rays}_r{r}_15n14even')
		with open(
				f' RZ13_2_dist_{round(dist, 2)}_foc_{round(focus, 2)}_rfoc_{round(r_foc, 2)}_positions_{number_rays}_r{r}_15n14even.pkl',
				'wb') as file:
